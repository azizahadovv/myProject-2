  ...
  return (
    <div className="w-full h-full bg-bleck ">
      ...
      <div className="body container w-[100%] min-height">
        <div className="mt-4">
          <p className="flex cursor-pointer justify-start items-center content-center text-[16px] font-normal font-BeauSans  leading-none gap-3 uppercase text-grayF">
            <AiOutlineLeft /> TARIFFS AND PACKAGES <span>| SILVER PLAN</span>
            <span className="text-white font-BeauSans">| your order</span>
          </p>
          <b className="flex items-center gap-3 text-[36px] font-BeauSans font-bold text-white">
